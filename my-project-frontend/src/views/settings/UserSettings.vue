...
<template>
  <div style="display: flex">
    <div class="settings-left">
      <card :icon="User" title="账号消息设置" desc="在这里编辑您的个人信息，您可以在隐私设置中选择是否展示这些信息">
      ...
      <div style="position: sticky; top: 20px">
        <card>
          <div style="text-align: center; padding: 5px 15px 0 15px">
            ...
            <div style="font-weight: bold; color: grey">{{store.user.username}}</div>
          </div>
        ...
        <card style="margin-top: 10px; font-size: 14px">
          ...
          <div style="color: grey; margin-top: 5px">欢迎加入我们的论坛！</div>
        </card>
      </div>
